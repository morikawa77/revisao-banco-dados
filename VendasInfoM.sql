...
insert into Pessoas (nome, cpf, status) values ('Reginaldo Morikawa', '111.111.111-11', 1)
go 

insert into Pessoas (nome, cpf) values ('Mario Henrique Pardo', '222.222.222-22')
go 


insert into Pessoas values ('Waldir Barros', '333.333.333-33', 2)
go 
...
insert into Clientes (pessoaId, renda, credito) values (1, 1500.00, 750.00)
go 

insert into Clientes values (3, 5000.00, 1500.00)
go 
